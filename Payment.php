        ...
        <ul class="navbar-nav ml-auto mb-2 mb-lg-0">
            ...
            <li class="nav-item dropdown">
				...
				<ul class="dropdown-menu">
					...
					<li><a class="dropdown-item" href="Rooms.php?room_id=R006S">King Suite</a></li>
				</ul>
        	</li>
            <li class="nav-item dropdown">
		...
		<div style="margin-left: 20vw; margin-right: 20vw;">
			<form action="pay.php" method="post">
				...
				<div class="mb-3 row">
					...
					<div class="col-sm-10">
						<input type="text" class="form-control" name="detail" value="<?php echo $detail; ?> " disabled>
					</div>
				</div>
				<div class="mb-3">
				...
				<h1 class="text-center mt-4 mb-3">Payment details</h1>
				<div class="mb-3 row">
